...
if($data_arr['method_name'] == "get_instructor_details") { 
    ...
    $condition = array ( 
        'select'       => 'e.emply_id, e.emply_name, e.emply_gender, e.emply_photo, 
                           e.emply_phone, e.emply_email, e.emply_permanent_address, 
    ...
    if($EMPLOYEES){
        ...
        $ins['address']                = $EMPLOYEES['emply_permanent_address'];
        ...
        $ins['education']              = $emp_education;
        $ins['languages']              = $emp_language;
        $ins['skills']                 = $emp_skills;
    }
