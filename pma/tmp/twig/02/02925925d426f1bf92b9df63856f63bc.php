...
yield _gettext("Go");
    ...
    {
        return new Source("", "table/insert/get_head_and_foot_of_insert_row_table.twig", "/home/mcdl.mul.edu.pk/public_html/pma/templates/table/insert/get_head_and_foot_of_insert_row_table.twig");
    }
}
