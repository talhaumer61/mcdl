...
if(isset($_POST['submit_add'])) {
	...
	if($dblms->getRows(COURSES, $condition)) {
		...
		$curs_credit_hours = (!empty($_POST['cur_credithours_theory']) ? $_POST['cur_credithours_theory'] : 0) + (!empty($_POST['cur_credithours_practical']) ? $_POST['cur_credithours_practical'] : 0);
		// SEQUENCING
		// $array = array();
		// $sequencing_category = '';
		...
		$values = array(
							...
							,'cur_credithours_theory'		=>	!empty($_POST['cur_credithours_theory']) ? $_POST['cur_credithours_theory'] : 0
							,'cur_credithours_practical'	=>	!empty($_POST['cur_credithours_practical']) ? $_POST['cur_credithours_practical'] : 0
