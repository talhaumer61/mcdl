...
// COURSE TO EDIT
$condition = array ( 
                     'select' 	    =>  ' curs_id, curs_type_status, curs_status, curs_wise, duration, id_level, id_cat, sequencing_category, curs_domain, id_dept, id_faculty, curs_code, curs_name, curs_code, curs_meta, curs_keyword, cur_credithours_theory, cur_credithours_practical, curs_credit_hours, curs_pre_requisite, curs_specialization, curs_type, curs_detail, curs_about, what_you_learn, how_it_work, curs_skills, curs_references, id_lang , curs_video, curs_rating, curs_hours'
                    ,'where' 	    =>  array( 
                                            'curs_id'    => $_GET['id']
                                        )
                    ,'return_type'  =>  'single'
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card mb-3">
            <div class="card-header bg-info">
                <h5 class="mb-0 modal-title"><i class="ri-edit-circle-line align-bottom me-1"></i>Edit '.$pageTitle.'</h5>
            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-2">
                                        ...
                                        <select class="form-control" data-choices name="sequencing_category[]" data-choices-removeItem multiple>
                                            <option value="">Choose multiple</option>';
