...
$condition  = [
                 'select'       =>  'c.curs_id, c.curs_name, COUNT(DISTINCT ec.id_std) AS std_count'
                ,'join'         =>  'INNER JOIN '.COURSES.' AS c ON ec.id_curs = c.curs_id'
                ,'where'        =>  [
                                        'ec.secs_status'   => 1,
                                        'ec.is_deleted'    => 0,
                                    ]
...
$COURSES_COUNT = $dblms->getRows(COURSES,$condition);
