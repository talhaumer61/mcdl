                ...
                <div class="tab-pane active" id="basic" role="tabpanel">
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            ...
                            <input type="file" name="photo" class="form-control" required accept="image/png, image/jpeg, image/jpg">
                        </div>
                ...
                <div class="tab-pane" id="contact" role="tabpanel">
                    <div class="row">                    
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="text" name="cnic" id="cleave-cnic" placeholder="xxxxx-xxxxxxx-x" class="form-control" required>
                        </div>
                        <div class="col-md-4 mb-2">
                            <label>Phone <span class="text-danger">*</span></label>
                            <input type="text" name="phone" id="cleave-pk-phone" placeholder="+92 xxx xxxxxxx" class="form-control" required>
                        </div>
