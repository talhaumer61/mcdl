<?php
$condition = array ( 
                    'select'        =>  'd.discount_id, d.discount_status, d.discount_name, d.discount_from, d.discount_to, d.is_all, d.discount_description'
                                ...
                                <div class="card-body border">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" name="discount_date" id="discount_date" data-provider="flatpickr" value="'.date('d M, Y', strtotime(cleanvars($DISCOUNT['discount_from']))).' to '.date('d M, Y', strtotime(cleanvars($DISCOUNT['discount_to']))).'" data-date-format="d M, Y" data-range-date="true" class="form-control" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mb-3">
                                <div class="card-header alert-primary">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="on_all_courses" id="on_all_courses" value="1" '.($DISCOUNT['is_all'] == 1?'checked':'').' >
                                ...
                                $condition = array ( 
                                                    ...
                                                    ,'join' 	    =>  'INNER JOIN '.COURSES.' AS c ON c.curs_id = dd.id_curs
                                                                            INNER JOIN '.ADMISSION_OFFERING.' AS ao ON ( ao.admoff_type = 3 AND ao.admoff_degree = dd.id_curs )'
                                                    ,'where' 	    =>  array( 
                                        ...
                                        <div class="col discount_on_all_courses_show" style="display: '.(!empty($DISCOUNT_DETAIL[0]['discount_type'])?'show':'none').';">';
                                            if ($DISCOUNT_DETAIL[0]['discount_type'] == 1) {
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="text" name="discount" class="form-control" value="'.$DISCOUNT_DETAIL[0]['discount'].'" onkeyup="discount_fixed_on_courses_apply(this.value);" placeholder="Fixed: 0.00" />
                                                </div>';
                                            }
                                            if ($DISCOUNT_DETAIL[0]['discount_type'] == 2) {
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="text" name="discount" class="form-control" value="'.$DISCOUNT_DETAIL[0]['discount'].'" onkeyup="discount_percentage_on_courses_apply(this.value);" placeholder="Percentage: 1-100%" />
                                                </div>';
                                            }
                                            echo'
                                        </div>
