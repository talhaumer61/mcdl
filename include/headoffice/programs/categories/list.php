...
$count = $dblms->getRows(PROGRAMS_CATEGORIES, $condition);
echo'
<div class="card">
    <div class="card-header">
        <div class="d-flex align-items-center">
            ...
            <div class="flex-shrink-0">
                <a class="btn btn-primary btn-sm" onclick="showAjaxModalZoom(\'include/modals/program_categories/add.php?ordering='.get_ordering(PROGRAMS_CATEGORIES).'\');"><i class="ri-add-circle-line align-bottom me-1"></i>'.moduleName(false).'</a>
            </div>
        </div>
    </div>
    <div class="card-body">        
        ...
        $rowsList = $dblms->getRows(PROGRAMS_CATEGORIES, $condition);
        if ($rowsList) {
            echo'
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar-sm bg-light rounded p-1">
                                                    <img src="uploads/images/programs/categories/icons/'.$row['cat_icon'].'" alt="" class="img-fluid d-block">
                                                </div>
                                            </div>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" style="cursor: pointer;">
                                            <li><a class="dropdown-item" onclick="showAjaxModalZoom(\'include/modals/program_categories/edit.php?cat_id='.$row['cat_id'].'\');"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                            <li><a class="dropdown-item" onclick="confirm_modal(\'program_categories.php?deleteid='.$row['cat_id'].'\');"><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>';
