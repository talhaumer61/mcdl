...
$viewNames = [
    'signup-report'                                 => 'signup_report',
    'registration-report'                           => 'registration_report',
    'students-detail-report'                        => 'student_individual_details',
...
<body>
    ...
    <div class="print-actions">
        <a href="'.($_SERVER['HTTP_REFERER'] ?? 'javascript:history.back()').'" class="btn btn-danger"><i class="ri-reply-line align-bottom me-1"></i>Back</a>
        <button class="btn btn-primary" onclick="window.print()"><i class="ri-printer-line align-bottom me-1"></i>Print</button>
        <button class="btn btn-success" id="export_button"><i class="ri-file-excel-2-line align-bottom me-1"></i>Export to Excel</button>
    </div>';
    ...
    echo'
    <!-- REPORT HEADER -->
    <div class="report-header d-flex align-items-center p-3 mb-0" style="border:1px solid black;">
        <!-- Logo -->
