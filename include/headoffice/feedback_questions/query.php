...
if(isset($_POST['submit_add'])) {
	...
	if($dblms->getRows(FEEDBACK_QUESTIONS, $condition, $sql)) {
		...
		$sqllms = $dblms->insert(FEEDBACK_QUESTIONS, $values);
		if($sqllms) { 
...
if(isset($_POST['submit_edit'])) {
	...
	if($dblms->getRows(FEEDBACK_QUESTIONS, $condition, $sql)) {
		...
		$sqllms = $dblms->Update(FEEDBACK_QUESTIONS, $values , "WHERE id  = '".cleanvars(LMS_EDIT_ID)."' ");
		if($sqllms) { 
...
if(isset($_GET['deleteid'])) {
	...
	$sqlDel = $dblms->Update(FEEDBACK_QUESTIONS, $values , "WHERE id  = '".cleanvars($_GET['deleteid'])."'");
	if($sqlDel) { 
