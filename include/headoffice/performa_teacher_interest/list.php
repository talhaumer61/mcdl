...
$condition = array(
                     'select'       =>  'id, status, id_section, type, question, options'
                    ,'where'        =>  array(
                                                'is_deleted'  => 0
                                            )
...
$count = $dblms->getRows(TEACHER_INTEREST_QUESTIONS, $condition);
echo'
<div class="card">
    ...
    <div class="card-body">        
        ...
        $rowsList = $dblms->getRows(TEACHER_INTEREST_QUESTIONS, $condition);
        if ($rowsList) {
            echo'
                    ...
                    <tbody>';
                        ...
                        foreach ($rowsList as $row) {
                            ...
                            <tr style="vertical-align: middle;">
                                ...
                                <td class="text-center">'.$row['id_section'].'</td>
                                <td>'.$row['question'].'</td>
                                <td class="text-center">'.get_QnsType($row['type']).'</td>
