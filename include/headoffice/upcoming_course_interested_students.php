                ...
                <div class="card">
                    ...
                    <div class="card-body">';
                        if ($STUDENT_INTERESTED_COURSES) {
                            ...
                            echo '<div class="table-responsive table-card" id="printResult">
                            ...
                            foreach ($grouped as $course_id => $data) {
                                ...
                                foreach ($data['students'] as $row) {
                                    $srno++;
                                    $curs_photo = (!empty($row['curs_photo']) && file_exists('uploads/images/courses/'.$row['curs_photo']))
                                        ? 'uploads/images/courses/'.$row['curs_photo']
                                        : 'uploads/default.png';
