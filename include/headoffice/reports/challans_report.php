                ...
                <div class="card-body">
                    <div class="row g-3 justify-content-center">
                        ...
                        if(!empty($_GET["pay_status"])){
                            echo '<input type="hidden" name="pay_status" value="'.$_GET["pay_status"].'">';
                        }
                        echo'
                        <div class="col-12 col-md-6 mb-2">
                            <label class="form-label">Payment Status</label>
                            <select name="pay_status" class="form-select" required data-choices '.(!empty($_GET["pay_status"]) ? "disabled" : "").'>
                                <option value="1" '.($_GET["pay_status"]  == "1" ? "selected" : "").'>Paid</option>
                                <option value="2" '.($_GET["pay_status"]  == "2" ? "selected" : "").'>Unpaid</option>
                            </select>
                        </div>
