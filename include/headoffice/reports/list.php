                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="mb-3">
                            <div class="first-list">
                                <div class="list-wrap">
                                    <a href="reports.php?view=signup-report" class="fw-medium text-primary">Signup Report</a>
                                </div>
                            </div>
                            <div class="first-list">
                                <div class="list-wrap">
                        ...
                        <li class="p-0 parent-title"><a href="javascript: void(0);" class="fw-semibold fs-14">Insterns</a></li>
                        <li class="mb-3">
                            <div class="first-list">
                                <div class="list-wrap">
                                    <a href="reports.php?view=interns-report" class="fw-medium text-primary">Interns Report</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="mb-3">
                            <div class="first-list">
                                <div class="list-wrap">
                                    <a href="reports.php?view=students-detail-report" class="fw-medium text-primary">Students Detail Report</a>
                                </div>
                            </div>
                            <div class="first-list">
                                <div class="list-wrap">
            ...
            <div class="col-sm-4">
                <div class="verti-sitemap">
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="p-0 parent-title"><a href="javascript: void(0);" class="fw-semibold fs-14">Inquiries</a></li>
                        <li class="mb-3">
                            <div class="first-list">
                                <div class="list-wrap">
                                    <a href="reports.php?view=inquiries-report" class="fw-medium text-primary">Inquiries Report</a>
                                </div>
                            </div>
                        </li>
