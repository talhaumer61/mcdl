            ...
            <form action="prints.php?view='.LMS_VIEW.'" method="POST" autocomplete="off">
                <div class="card-body">
                    <div class="row g-3 justify-content-center">
                        ...
                        <div class="col-12 '.(isset($_GET['enroll_type']) ? 'col-md-6' : 'col-md-4').' mb-2">
                        ...
                        if(!empty($_GET['enroll_type'])) {
                            echo '
                            <input type="hidden" id="enroll_type" name="enroll_type" value="'.$_GET['enroll_type'].'">
                            ';
                        }
                        else{
