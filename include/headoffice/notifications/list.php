                    ...
                    <tbody>';
                        ...
                        foreach ($rowsList as $row) {
                            ...
                            <tr style="vertical-align: middle;">
                                ...
                                <td>';
                                    foreach (explode(',', $row['display_location']) as $key => $value) {
                                        echo '<span class="mx-1">'.get_display_location($value).'</span>';
                                    }
                                    echo'
                                </td>
                                <td>';
                                    foreach (explode(',', $row['display_audience']) as $key => $value) {
                                        echo '<span class="mx-1">'.get_display_audience($value).'</span>';
                                    }
                                    echo'
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" style="cursor: pointer;">
                                            ...
                                            <li><a class="dropdown-item" onclick="showAjaxModalZoom(\'include/modals/'.moduleName().'/edit.php?edit_id='.$row['not_id'].'&view='.moduleName().'\');"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                            <li><a class="dropdown-item" onclick="confirm_modal(\''.moduleName().'.php?deleteid='.$row['not_id'].'\');"><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>';
