    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <!-- Academics -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAcademics" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAcademics">
                        <i class="bx bxs-bank"></i> <span data-key="t-academics">Academics</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarAcademics">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item"><a class="nav-link" href="faculties.php"><i class="ri-community-line"></i> <span data-key="t-dashboard">Faculties</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="departments.php"><i class="ri-building-2-line"></i> <span data-key="t-departments">Departments</span></a></li>                            
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarEmployees">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item"><a href="interns.php" class="nav-link" data-key="t-interns"> Interns</a></li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="#sidebarTeachers" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarTeachers">
                                    <i class="ri-group-line"></i> <span data-key="t-teachers">Teachers</span>
                                </a>
                                <div class="collapse menu-dropdown" id="sidebarTeachers">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item"><a href="teacher_engagement_interest.php" class="nav-link" data-key="t-teacher-engagement-interest">Teacher Engagement Interest</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
                ...
                <!-- Learnings -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLearnings" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLearnings">
                        <i class="bx bx-layer"></i> <span data-key="t-learnings">Learnings</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarLearnings">
                        <ul class="nav nav-sm flex-column">                            
                            <li class="nav-item">
                ...
                <!-- Outreach -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarOutreach" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarOutreach">
                        <i class="bx bx-speaker"></i> <span data-key="t-outreach">Outreach</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarOutreach">
                        <ul class="nav nav-sm flex-column">                            
                            <li class="nav-item"><a class="nav-link menu-link" href="skill_ambassador.php"><i class="ri-coupon-line"></i> <span data-key="t-skill_ambassador">Skill Ambassador</span></a></li>
                            <li class="nav-item"><a class="nav-link menu-link" href="coupons.php"><i class="ri-coupon-line"></i> <span data-key="t-coupons">Coupons</span></a></li>
                            <li class="nav-item"><a class="nav-link menu-link" href="discounts.php"><i class="ri-coupon-fill"></i> <span data-key="t-discounts">Discounts</span></a></li>
                            <li class="nav-item"><a class="nav-link menu-link" href="referral_control.php"><i class="ri-list-settings-line"></i> <span data-key="t-referral-control">Referral Control</span></a></li>
                            <li class="nav-item"><a class="nav-link menu-link" href="blogs.php"><i class="ri-cast-line"></i> <span data-key="t-blogs">Blogs</span></a></li>
                            <li class="nav-item"><a class="nav-link menu-link" href="inquiries.php"><i class="ri-question-line"></i> <span data-key="t-inquiries">Inquiries</span></a></li>
                        </ul>
                    </div>
                </li>
