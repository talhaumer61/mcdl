...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header bg-light p-3">
            <h5 class="modal-title text-dark" id="exampleModalLabel"><i class="ri-add-circle-line align-bottom me-1"></i>Add Substate</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <input type="number" value="'.$_GET['ordering'].'" name="substate_ordering" class="form-control" required="" readonly="">
                    </div>
                    <div class="col mb-2">
