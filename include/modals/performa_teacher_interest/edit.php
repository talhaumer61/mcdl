...
$row = $dblms->getRows(TEACHER_INTEREST_QUESTIONS, $condition);
            ...
            <div class="modal-body">
                <div class="row"> 
                    ...
                    <div class="col mb-2">
                        ...
                        <select class="form-control" data-choices id="id_section" name="id_section" required>
                            <option value=""> Choose one</option>';
                            foreach (get_teacher_interest_section() as $key => $value) {
                                echo'<option value="'.$key.'" '.($key == $row['id_section'] ? 'selected' : '').'>'.$key.' - '.$value.'</option>';
                            }
                            echo'
                        </select>
                    </div>
