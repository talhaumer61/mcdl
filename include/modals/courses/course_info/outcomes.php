...
$btn = (empty($result['outcomes']) ? 'add' : 'edit');
$modal = (empty($result['outcomes']) ? 'primary' : 'info');
echo'
<script src="assets/js/app.js"></script>
<div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header bg-light p-3">
            <h5 class="modal-title text-dark" id="exampleModalLabel"><i class="ri-'.$btn.'-circle-line align-bottom me-1"></i>'.ucfirst($btn).' Outcomes</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <textarea id="ckeditor1" name="outcomes" class="form-control" required>'.(isset($result) ? html_entity_decode($result['outcomes']) : '').'</textarea>
                    </div>
                </div>
            </div>
