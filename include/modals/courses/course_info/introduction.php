...
$btn = (empty($row['introduction']) ? 'add' : 'edit');
$modal = (empty($row['introduction']) ? 'primary' : 'info');
echo'
<script src="assets/js/app.js"></script>
<div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-header bg-'.$modal.' p-3">
            <h5 class="modal-title" id="exampleModalLabel"><i class="ri-'.$btn.'-circle-line align-bottom me-1"></i>'.ucfirst($btn).' Introduction</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <textarea id="ckeditor1" name="introduction" class="form-control" required>'.(isset($row) ? html_entity_decode($row['introduction']) : '').'</textarea>
                    </div>
                </div>
            </div>
