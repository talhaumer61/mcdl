            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <input class="form-control" type="text" name="date_start" id="date_start" required data-provider="flatpickr" data-date-format="Y-m-d">
                    </div>
                    <div class="col mb-2">
                        <label class="form-label" for="card-name">End Date <span class="text-danger">*</span></label>
                        <input class="form-control" type="text" name="date_end" id="date_end" required data-provider="flatpickr" data-date-format="Y-m-d">
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-2">
