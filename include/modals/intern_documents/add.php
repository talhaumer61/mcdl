...
<div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
        ...
        <form autocomplete="off" class="form-validate"  enctype="multipart/form-data" method="post" accept-charset="utf-8">
            <input type="hidden" name="id_intern" value="'.$_GET['id_intern'].'">
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <input class="form-control" type="text" name="doc_title" required>
                    </div>
                </div>                
                <div class="row">
                    <div class="col mb-2">
                        <label class="form-label">File <span class="text-danger">*</span></label>
                        <input class="form-control" type="file" name="doc_file" required accept=".jpg,.jpeg,.png,.pdf,">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <div class="hstack gap-2 justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm" name="submit_add_document"><i class="ri-add-circle-line align-bottom me-1"></i>Add '.moduleName(LMS_VIEW).'</button>
                </div>
            </div>
        </form>
    </div>
