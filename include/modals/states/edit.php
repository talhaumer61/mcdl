...
$result     = $settingcls->get_state($_GET['state_id']);
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header bg-light p-3">
            <h5 class="modal-title text-dark" id="exampleModalLabel"><i class="ri-edit-circle-line align-bottom me-1"></i>Edit State</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <input type="text" name="state_name" value="'.$result['state_name'].'" class="form-control" required />
                    </div>
                    <div class="col mb-2">
                        <label class="form-label">Ordering <span class="text-danger">*</span></label>
                        <input type="number" value="'.$result['state_ordering'].'" name="state_ordering" class="form-control" required="" readonly="">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <input type="number" name="state_codedigit" value="'.$result['state_codedigit'].'" class="form-control" required />
                    </div>
                    <div class="col mb-2">
                        <label class="form-label">Code (Alpha) <span class="text-danger">*</span></label>
                        <input type="text" name="state_codealpha" value="'.$result['state_codealpha'].'" class="form-control" required />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <input type="text" name="state_latitude" value="'.$result['state_latitude'].'" class="form-control" required />
                    </div>
                    <div class="col mb-2">
                        <label class="form-label">Longitude <span class="text-danger">*</span></label>
                        <input type="text" name="state_longitude" value="'.$result['state_longitude'].'" class="form-control" required />
                    </div>
                </div>
                    ...
                    <div class="col mb-2">
                        ...
                        <select class="form-control" data-choices name="state_status" required>
                            ...
                            foreach(get_status() as $key => $status):
                                echo'<option value="'.$key.'" '.($result['state_status'] == $key ? 'selected' : '').'>'.$status.'</option>';
                            endforeach;
                            echo'
                        </select>
                    </div>
