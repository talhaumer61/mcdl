...
define('INQUIRIES'                          , 'cms_inquiries');
define('INTERNS'                            , 'cms_interns');
define('INTERN_DOCS'                        , 'cms_intern_documents');
...
define("SITE_URL"			, "https://localhost/gpt/mcdl.mul.edu.pk/");
define("WEBSITE_URL"        , "https://localhost/gpt/dodl.mul.edu.pk/");
define('LMS_IP'				, $ip);
define('LMS_DO'				, $do);
