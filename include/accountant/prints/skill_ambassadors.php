        ...
        foreach ($grouped as $ambName => $rows) {
            ...
            echo '
                <tr>    
                    ...
                    <td>'.$ambName.'</td>
                    <td class="text-center">'.($rows[0]['org_telephone'] ? $rows[0]['org_telephone'] : '-' ).'</td>
                    <td>'.($rows[0]['org_email'] ? $rows[0]['org_email'] : '-' ).'</td>
                    <td class="text-center">'.($rows[0]['org_city'] ? $rows[0]['org_city'] : '-' ).'</td>
                    <td class="text-center">'.$totalSignups.'</td>
                    <td class="text-center">'.$totalEnrollments.'</td>
                    <td class="text-center">'.number_format($totalRevenue).'</td>
                    <td class="text-center">'.number_format($incentive).'</td>
                    <td class="text-center">'.$rows[0]['org_link_to'].'</td>
                </tr>
                ';
        }
