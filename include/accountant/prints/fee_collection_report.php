...
$searchBy = " AND cc.paid_date BETWEEN '{$fromDate} 00:00:00' AND '{$toDate} 23:59:59'";
...
$condition = array(
    'select'      => 'cc.challan_id, cc.challan_no, cc.total_amount, cc.paid_amount, cc.status, cc.pay_mode, cc.issue_date, cc.date_added, cc.paid_date, s.std_name',
...
$db_data = $dblms->getRows(CHALLANS.' cc', $condition, $sql);
...
if (empty($db_data) || $db_data === false) {
    ...
    <div class="card">
        <div class="card-body p-0">
            <div>
                <table class="align-middle mb-0" id="printResult">
    ...
    foreach ($db_data as $row) {
        ...
        <tr>
            ...
            <td class="text-center">'.date('d M, Y', strtotime($row['paid_date'])).'</td>
    ...
    echo '
                    ...
                    <tfoot class="table-light">
                        <tr>
                            <th colspan="7" class="text-end fw-bold">TOTAL AMOUNT:</th>
