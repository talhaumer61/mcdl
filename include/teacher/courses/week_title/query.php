...
if(isset($_POST['submit_add'])) {
	...
	if($dblms->getRows(COURSES_WEEK_TITLE, $condition)) {		
		...
		$sqllms	= $dblms->insert(COURSES_WEEK_TITLE, $values);
...
if(isset($_POST['submit_edit'])) {
	...
	if($dblms->getRows(COURSES_WEEK_TITLE, $condition)) {
		...
		$sqllms = $dblms->Update(COURSES_WEEK_TITLE, $values, "WHERE id = '".LMS_EDIT_ID."'");
...
if(isset($_GET['deleteid'])) {
	...
	$sqlDel = $dblms->Update(COURSES_WEEK_TITLE , $values , "WHERE id = '".cleanvars($latestID)."'");
	if($sqlDel) { 
