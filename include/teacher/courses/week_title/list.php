...
$count = $dblms->getRows(COURSES_WEEK_TITLE, $condition);
echo'
<style type="text/css">
        .table-responsive {
    ...
    <div class="col-3">
        <form class="form-horizontal" id="form" enctype="multipart/form-data" method="get" autocomplete="off" accept-charset="utf-8">
            ...
            <div class="input-group mb-3">
                <input type="text" id="searchInput" class="form-control" placeholder="Search..." name="search_word" value="'.$search_word.'">
...
$rowslist = $dblms->getRows(COURSES_WEEK_TITLE, $condition);
if ($rowslist) {
    echo'
        ...
        <table class="table table-bordered mb-0">
            <thead class="table-light">
                <tr>
                    ...
                    <th>Title</th>
                    <th width="70" class="text-center">'.get_CourseWise($curs['curs_wise']).'</th>
            ...
            <tbody>';
                ...
                foreach ($rowslist as $row) :
                    ...
                    <tr style="vertical-align: middle;">
                        ...
                        <td>'.$row['caption'].'</td>
                        <td class="text-center">'.$row['id_week'].'</td>
