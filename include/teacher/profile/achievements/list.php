...
$condition = array(
                        'select'       =>  'id,title,organization,dated,detail'
                        ,'where' 	    =>  array   (  
                                                         'is_deleted'           => 0
...
$count = $dblms->getRows(EMPLOYEE_ACHIEVEMENTS, $condition);
echo'
...
$data = $dblms->getRows(EMPLOYEE_ACHIEVEMENTS, $condition);
if ($data) {
    echo'
                        ...
                        <td class="text-center">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" style="cursor: pointer;">
                                    <li><a class="dropdown-item" onclick="showAjaxModalZoom(\'include/modals/'.moduleName().'/'.LMS_VIEW.'/edit.php?achiev_id='.$row['id'].'\');"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
