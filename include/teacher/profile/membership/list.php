...
$condition = array(
                        'select'       =>  'id,organization,designation,memno,startdate,enddate'
                        ,'where' 	    =>  array   (  
                                                         'is_deleted'           => 0
...
$count = $dblms->getRows(EMPLOYEE_MEMBERSHIPS, $condition);
echo'
...
$data = $dblms->getRows(EMPLOYEE_MEMBERSHIPS, $condition);
if ($data) {
    echo'
                        ...
                        <td class="text-center">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" style="cursor: pointer;">
                                    <li><a class="dropdown-item" onclick="showAjaxModalZoom(\'include/modals/'.moduleName().'/'.LMS_VIEW.'/edit.php?mem_id='.$row['id'].'&view='.cleanvars($_GET['view']).'\');"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
